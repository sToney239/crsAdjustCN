...
The goal of crsAdjustCN is to transform between special coordinate systems in China and WGS 84, especially for `sf` objects.
...
```
you could provide your object of `sf` class and specify the from and to coordicates. (Please note that currently this function could only deal with geometry type of `POINT`, `LINESTRING`, `POLYGON`, `MULTIPOINT`, `MULTILINESTRING` and `MULTIPOLYGON`)
