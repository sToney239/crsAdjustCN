...
``` r
crsAdjustCN::st_crs_adjust(obj = your_sf_object, from = "bd", to = "wgs")
```

you could provide your object of `sf` class and specify the from and to
coordicates. (Please note that currently this function could only deal
with geometry type of `POINT`, `LINESTRING`, `POLYGON`, `MULTIPOINT`,
